...
const Patients = () => {
  ...
  // Helper to fetch robust patient keys
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Age/DOB</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {isLoading ? (
              <tr>
                <td colSpan="7" className="px-6 py-4 text-center text-gray-500">Loading patients...</td>
              </tr>
              ...
              filteredPatients.map((patient) => (
                <tr key={getPatientProperty(patient, 'P_ID')} className="hover:bg-gray-50 transition-colors">
