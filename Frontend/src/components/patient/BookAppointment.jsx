              ...
              <div className="flex items-center mb-4">
                <div className="h-16 w-16 rounded-full bg-primary-100 flex items-center justify-center mr-4 border-2 border-white shadow-md">
                  {selectedDoctor.image ? (
                    <img 
                      src={`data:image/jpeg;base64,${String(selectedDoctor.image || '')}`} 
                      alt={String(selectedDoctor.Name || selectedDoctor.name || 'Doctor')}
                ...
                <div>
                  <h3 className="text-lg font-medium text-gray-900">
                    {String(selectedDoctor.Name || selectedDoctor.name || selectedDoctor.drName || 'Dr. Unknown')}
                  </h3>
                  <p className="text-sm text-gray-600">
                    {String(selectedDoctor.Specialization || selectedDoctor.specialization || 'General Practitioner')}
                  </p>
                  {selectedDoctor.fee && (
              ...
              <div className="grid grid-cols-2 gap-4 text-sm text-gray-700">
                {selectedDoctor.email && (
                  <div className="flex items-center">
                    ...
                    <span>{String(selectedDoctor.email)}</span>
                  </div>
                )}
                {selectedDoctor.phone && (
                  <div className="flex items-center">
                    <PhoneIcon className="h-4 w-4 text-gray-500 mr-2" />
                    <span>{String(selectedDoctor.phone)}</span>
                  </div>
                )}
              </div>
            </div>
