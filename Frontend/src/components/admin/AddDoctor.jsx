...
const AddDoctor = ({ onClose, onDoctorAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.mobileNo.length !== 10 || !/^[0-9]{10}$/.test(formData.mobileNo)) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Name */}
            <div>
              <label htmlFor="drName" className="block text-sm font-medium text-gray-700 mb-1">Doctor's Name*</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:ring-primary-500 focus:border-primary-500"
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full rounded-md border border-gray-300 py-2 px-3 shadow-sm focus:ring-primary-500 focus:border-primary-500"
                required
              >
          ...
          <div className="mt-8 flex justify-end space-x-3">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:ring-primary-500"
              disabled={isLoading}
            >
              Cancel
            </button>
            <button
              type="submit"
              className={`px-6 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:ring-primary-500 ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`}
              disabled={isLoading}
            >
